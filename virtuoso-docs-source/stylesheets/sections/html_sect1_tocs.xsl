...
<xsl:for-each select="./sect1">
  ...
  <xsl:when test="./@id='functions' and name(.) = 'chapter'" >
	...
	<xsl:for-each select="/book/chapter[@id = 'functions']/refentry[refmeta/refmiscinfo = $funccat]"><xsl:sort select="@id" />
          <div><xsl:call-template name="function-micro-data" /><a class="sect2" href="{./@id}.html"><xsl:apply-templates select="refmeta/refentrytitle"/></a></div>
        </xsl:for-each>
    </xsl:for-each>
    </div>
  </xsl:when>
...
<xsl:choose>
  <xsl:when test="not($chapnodenav)">
    <a class="feedlnk" href="{/book/@id}.rdfxml" title="SIOC(RDF/XML)"><img hspace="3" src="/doc/rdf_flyer-16.gif" alt="SIOC(RDF/XML)" title="SIOC(RDF/XML)"/></a>
  ...
  <xsl:otherwise>
    <a class="feedlnk" href="{parent::chapter/@id|self::chapter/@id}.rdfxml" title="SIOC(RDF/XML)"><img hspace="3" src="/doc/rdf_flyer-16.gif" alt="SIOC(RDF/XML)" title="SIOC(RDF/XML)"/></a>
    ...
    <xsl:if test="parent::chapter|self::chapter">
      ...
      <a class="feedlnk" href="{parent::chapter/@id|self::chapter/@id}.atom" title="Stay up-to-date with this chapter using ATOM">
