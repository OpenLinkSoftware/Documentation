...
<!-- ==================================================================== -->
	...
	<xsl:variable name="chap">relnotes</xsl:variable>
			<!-- Variables -->
...
<HR/>
    ...
    <TD ALIGN="RIGHT" VALIGN="middle">
    <P CLASS="vtabfoot">Copyright <xsl:value-of select="year-from-date(xs:date(substring(string(current-dateTime()),1,10)))"/>, <xsl:value-of select="/book/bookinfo/copyright/holder"/></P>
    </TD></TR></TABLE>
