...
<xsl:text>
==================================================================================
Copyright </xsl:text><xsl:value-of select="year-from-date(xs:date(substring(string(current-dateTime()),1,10)))"/><xsl:text>, </xsl:text><xsl:value-of select="/book/bookinfo/copyright/holder"/>
